...
var NewsRecognitionSpotlightMosaic = (0, react_1.lazy)(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1: return [2 /*return*/, (_b.default = (_c.sent()).NewsRecognitionSpotlightMosaic,
                    _b)];
        }
    });
}); });
var PersonalizedLowerZoneSeam = (0, react_1.lazy)(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1: return [2 /*return*/, (_b.default = (_c.sent()).PersonalizedLowerZoneSeam,
                    _b)];
        }
    });
}); });
var GlobalUtilityFooter = (0, react_1.lazy)(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1: return [2 /*return*/, (_b.default = (_c.sent()).GlobalUtilityFooter,
                    _b)];
        }
    });
}); });
...
function HbCentralHomepageHost(_b) {
    var _c = _b.shellState, shellState = _c === void 0 ? "ready" : _c, _d = _b.includePersonalizedLowerZone, includePersonalizedLowerZone = _d === void 0 ? false : _d;
    var orderedSections = (0, react_1.useMemo)(function () { return homepageComposition_1.HOMEPAGE_COMPOSITION_MANIFEST.filter(function (entry) { return !(entry.id === "personalizedLowerZone" && !includePersonalizedLowerZone); }); }, [includePersonalizedLowerZone]);
    if (shellState !== "ready") {
