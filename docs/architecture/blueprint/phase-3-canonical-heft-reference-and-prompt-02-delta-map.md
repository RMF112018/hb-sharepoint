...
| Runtime bridge                      | Wrappers import `../../../dist/homepage.js` built by Vite                                 | Per-surface ownership path without shared `dist/homepage.js` production dependency | `retire-later` | Removed in subsequent runtime refactor prompts          |
