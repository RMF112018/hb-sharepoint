...
var priorityCardStyle = Object.assign(Object.assign({}, actionCardStyle), { border: "1px solid ".concat(ui_kit_1.hbcSemanticTokens.actionAccent), background: ui_kit_1.hbcSemanticTokens.surfaceAccent });
function QuickActionsDeck(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("section", { "aria-labelledby": "quick-actions-heading", "data-source-mode": adapted.sourceMode, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: "grid", gap: ui_kit_1.hbcSpacingTokens.sm, marginBottom: ui_kit_1.hbcSpacingTokens.md }, children: [(0, jsx_runtime_1.jsx)(ui_kit_1.HbcBadge, { children: "Quick Actions" }), (0, jsx_runtime_1.jsx)("h2", { id: "quick-actions-heading", style: {
                        ...
                        }, children: "Quick actions deck" })] }), (0, jsx_runtime_1.jsx)("div", { "data-testid": "quick-actions-groups", style: groupGridStyle, children: groups.map(function (group) { return ((0, jsx_runtime_1.jsxs)("section", { "aria-labelledby": "quick-actions-group-".concat(group.id), children: [(0, jsx_runtime_1.jsx)("h3", { id: "quick-actions-group-".concat(group.id), style: { margin: "0 0 ".concat(ui_kit_1.hbcSpacingTokens.sm, " 0"), color: ui_kit_1.hbcSemanticTokens.textPrimary }, children: group.title }), (0, jsx_runtime_1.jsx)("div", { "data-testid": "quick-actions-wrap", "data-responsive-contract": "grid-stack", className: "hb-responsive-grid hb-grid-actions hb-layout-tier-marker", style: actionGridStyle, children: group.items.map(function (action) { return ((0, jsx_runtime_1.jsxs)("a", Object.assign({}, (0, homepageHardening_1.getHomepageLinkProps)({
                                href: action.href,
                                purpose: "Open action ".concat(action.label),
                                external: action.external,
                            }), { style: action.priority ? priorityCardStyle : actionCardStyle, "data-priority": action.priority ? "true" : "false", children: [(0, jsx_runtime_1.jsx)("strong", { style: { color: ui_kit_1.hbcSemanticTokens.textPrimary }, children: action.label }), action.description ? ((0, jsx_runtime_1.jsx)("span", { style: { color: ui_kit_1.hbcSemanticTokens.textSecondary }, children: action.description })) : null, (0, jsx_runtime_1.jsx)("small", { style: { color: ui_kit_1.hbcSemanticTokens.textSecondary }, children: action.external ? "External destination" : "Internal destination" })] }), action.id)); }) })] }, group.id)); }) })] }));
}
