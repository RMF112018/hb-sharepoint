...
export interface FeaturedProjectsSourceModel {
  items: readonly FeaturedProjectItem[];
}

export const SEEDED_FEATURED_PROJECTS_SOURCE: FeaturedProjectsSourceModel = {
  items: [
    {
...
export function normalizeFeaturedProjects(
  source: FeaturedProjectsSourceModel,
): FeaturedProjectItem[] {
